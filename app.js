    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("input", { type: "text", value: this.state.text, o: true,
  ...
  _createClass(TodoList, [{
    ...
    value: function render() {
      var todoList = this.state.todos.map(function (todo) {
        return React.createElement(Todo, { id: todo._id, key: todo._id, text: todo.text, done: todo.done });
      });
